...
describe('Students functions:getNumStudents', () => {
    ...
    it('should return 1 if there is 1 students', () => {
        const dummyStudent = [{firstname : 'john', lastname: 'doe', age:30}]
        expect(getNumStudents(dummyStudent)).toEqual(1)
    });
...
describe('Students functions: getAverageAge', () => {
    ...
    it('should return the age of the student if there is only one student', () => {
        const dummyStudent2 = [{firstname: 'john', lastname: 'doe', age: 20}]
        expect(getAverageAge(dummyStudent2)).toEqual(20)
    });
